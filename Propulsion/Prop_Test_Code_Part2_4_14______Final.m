...
% - Need to add xenon for E passivation
...
%% =========================================================
%% Dry Mass (kg)
sc_dry_mass_no_prop_system= 2300;
...
margin_dV = 0.05;
margin_residual = 0.03;
margin_system = 0.05;
prop_margin = margin_dV + margin_residual + margin_system;
...
fprintf('\nTotal Tank Diameter Combined: %.2f m', D_xe + D_NTO + D_MMH);
%% Helper Function
