...
% Set up MultiObj
MultiObj.fun = @(x) batch_Lambert_J2_drift_transfer(x0_d_keplerian, [x(:, 3)' * char_star.l; x(:, 4:5)'; repmat(x0_d_keplerian(4:6), 1, size(x, 1))], x0_c_keplerian, x(:, 1:2)' * 3600, 60, mu_E, R_E, J_2_val, char_star, 1, 365);
